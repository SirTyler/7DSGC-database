        ...
        return (
            ...
            {(theme) => (
                <div style={{padding: "5px"}}>
                    Applies {this.effects[0].display} on the hero at the start of battle for <span className={`subeffect ${theme.theme}`}> 1 turn. </span>
                    ...
                    <span className={`effect ${theme.theme}`}>When hit with a skill during the enemy's turn</span>, the hero's {this.effects[1].display} increase by <span className={`damage ${theme.theme}`}>10%</span>, up to <span className={`subeffect ${theme.theme}`}>5 times</span>, for <span className={`subeffect ${theme.theme}`}>3 turns</span>.
